...
// Calibrate values
#define TS_MINX 133   //200
#define TS_MINY 101   //100           //200
#define TS_MAXX 928   //870           //900
#define TS_MAXY 862   //840           //905
  ...
  if (p.z > MINPRESSURE && p.z < MAXPRESSURE) {
    ...
    */
    ...
    if (p.y < (TS_MINY-5)) {
      ...
      tft.fillRect(0, BOXSIZE, tft.width(), tft.height()-BOXSIZE, BLACK);  //<---dp
	  //tft.fillRect(0, BOXSIZE*1, tft.width(), tft.height()-BOXSIZE*1, WHITE);
    }
    ...
    //p.x = map(p.x, TS_MINX, TS_MAXX, 0, tft.width());  //<---dp
    // *** SPFD5408 change -- End
    //p.y = map(p.y, TS_MINY, TS_MAXY, 0, tft.height()); //<---dp
